...
const questions = [
  { question: "The title of 'Fahrenheit 451' was \n  originally 'The Fireman'.", answer: "t"},
  { question: "J.K. Rowling came up with the idea \n  for 'Harry Potter' on an airplane.", answer: "f"},
  { question: "C.S. Lewis' 'Chronicles of Narnia' \n  was originally called 'The Tales of Aslan'.", answer: "f"},
  { question: "As a child, Roald Dahl was a \n  taste-tester for Cadbury's chocolate.", answer: "t"},
  { question: "J.R.R. Tolkien learned over 18 \n  languages and invented languages for fun.", answer: "t"}
];
